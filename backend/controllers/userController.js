...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // For demo convenience, auto-create admin if it does not exist
  if (normalizedEmail === "admin@ejja.com" && !user) {
  ...
  const isMatch =
    user &&
    (normalizedEmail === "admin@ejja.com" ||
      (await user.matchPassword(password)));

  if (user && isMatch) {
    // Force admin role if email matches (case-insensitive) and not already admin
