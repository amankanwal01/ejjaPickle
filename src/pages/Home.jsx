      ...
      <section className="hero">
        <div className="hero-content">
          <div className="hero-text">
            ...
            <h1>The Soul of the <span>Himalayas</span> in a Jar.</h1>
            <p>Hand-pounded spices, sun-matured mountain fruits, and the ancient wisdom of Kumaon. Every jar is a journey back to the hills.</p>
          ...
          <div className="hero-image">
            <img src="https://images.unsplash.com/photo-1544145945-f904253db0ad?q=80&w=1200&auto=format&fit=crop" alt="Premium Pickles" />
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="banner-box">
            <div className="banner-content">
              ...
              <p>Pick any 3 or 5 jars and create a custom combination tailored to your palate.</p>
              <Link to="/combo" className="btn-primary">Start Building</Link>
            </div>
          </div>
        </div>
      </section>
